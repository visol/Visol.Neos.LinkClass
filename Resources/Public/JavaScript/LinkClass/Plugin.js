...
})), _dec(_class = _dec2(_class = (_temp = _class2 = class LinkEditorOptions extends _react.PureComponent {
...
var _findLinkRange = __webpack_require__(/*! ./_findLinkRange */ "./src/_findLinkRange.js");

var _findLinkRange2 = _interopRequireDefault(_findLinkRange);

var _toMap = __webpack_require__(/*! ./_toMap */ "./src/_toMap.js");

var _toMap2 = _interopRequireDefault(_toMap);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var LinkAttributeCommand = class LinkAttributeCommand extends _ckeditor5Exports.Command {
        ...
        model.change(function (writer) {
            if (toggleMode && !value) {
                ...
                if (selection.hasAttribute("linkHref")) {
                    ...
                    if (value === false) {
                        writer.removeAttribute(_this.attributeKey, linkRange);
                    } else {
                        writer.setAttribute(_this.attributeKey, value, linkRange);
...
var _linkAttributeCommand = __webpack_require__(/*! ./linkAttributeCommand */ "./src/linkAttributeCommand.js");

var _linkAttributeCommand2 = _interopRequireDefault(_linkAttributeCommand);

var _removeAttributeCommand = __webpack_require__(/*! ./removeAttributeCommand */ "./src/removeAttributeCommand.js");

var _removeAttributeCommand2 = _interopRequireDefault(_removeAttributeCommand);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var LinkClassPlugin = class LinkClassPlugin extends _ckeditor5Exports.Plugin {
...
var _linkEditorPlugin = __webpack_require__(/*! ./linkEditorPlugin */ "./src/linkEditorPlugin.js");
...
var RemoveAttributeCommand = class RemoveAttributeCommand extends _ckeditor5Exports.Command {
    constructor(editor, attributeKey) {
        super(editor);
    ...
    execute(value) {
        ...
        model.change(function (writer) {
            var rangesToUnset = selection.isCollapsed ? [_findRange(selection.getFirstPosition(), selection.getAttribute(_this.attributeKey), model, _this.attributeKey)] : selection.getRanges();
            var _iteratorNormalCompletion = true;
            var _didIteratorError = false;
            var _iteratorError = undefined;
